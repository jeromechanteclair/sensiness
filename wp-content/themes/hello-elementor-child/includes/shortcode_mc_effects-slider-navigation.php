 ...
 * 
 * @return string $html : The effects slider navigation HTML
 */
function mc_effects_slider_navigation() {
  ...
  $html = '<nav class="mc_categories-slider-navigation mc_categories-slider-navigation--effects"><ul>';

  global $wp_query;
  $queried_object = $wp_query->get_queried_object();

  foreach ($categories as $category) {
    $category_activated = get_field('effects_slider', $category->taxonomy . '_' . $category->term_id);
...
// Register shortcode
add_shortcode('mc_effects-slider-navigation', 'mc_effects_slider_navigation');