...
class Images
{
    public function __construct()
    {
		...
		add_image_size('single_thumbnail', '448', '252', true);
		...
		add_image_size('product_thumbnail_big_desktop', 920, 600,true);
		add_image_size('product_thumbnail_medium_desktop', 448, 600,true);
		add_image_size('product_thumbnail_normal_desktop', 400, 400,true);
		add_image_size('product_thumbnail_normal_mobile', 312, 312,true);
		add_image_size('product_thumbnail_normal_mobilex2', 624, 624,true);
