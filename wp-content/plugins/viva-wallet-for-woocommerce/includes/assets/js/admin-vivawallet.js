...
jQuery( document ).ready(
	function () {
		...
		function woo_vivawallet_show_test_mode_inputs()
		{
			...
			jQuery( '#woocommerce_vivawallet_native_test_apple_pay' ).parent().parent().parent().parent().show();
		...
		function woo_vivawallet_hide_test_mode_inputs()
		{
			...
			jQuery( '#woocommerce_vivawallet_native_test_apple_pay' ).parent().parent().parent().parent().hide();
		...
		function woo_vivawallet_show_live_mode_inputs()
		{
			...
			jQuery( '#woocommerce_vivawallet_native_apple_pay' ).parent().parent().parent().parent().show();
		...
		function woo_vivawallet_hide_live_mode_inputs()
		{
			...
			jQuery( '#woocommerce_vivawallet_native_apple_pay' ).parent().parent().parent().parent().hide();
