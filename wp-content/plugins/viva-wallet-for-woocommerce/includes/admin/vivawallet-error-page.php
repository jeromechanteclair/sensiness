...
$error_message_two = __( 'Merchants can use one of these currencies (EUR, GBP, BGN, PLN, RON, DKK, CZK, HRK) which should be the same as their Viva Wallet account currency.', 'viva-wallet-for-woocommerce' );
