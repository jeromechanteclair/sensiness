	...
	class WPCE_Usage_Feedback {
		...
		public function send_data( $body ) {
			...
			foreach($body as $key=>$value){
			    ...
			    $title   = esc_html('Elementor WooCommerce Product Carousel Slider PRO Plugin Deactivation Notice');
				$headers = array('From: Elementor WooCommerce Product Carousel Slider PRO <mailer@just-a-fake-from-address.com>');
		...
		public function goodbye_ajax() {
			...
			<script>
				jQuery(document).ready(function($){
					 $(document).on('change', '#wpb-goodbye-form-woo-product-carousel-slider-for-elementor-pro input[type=radio]',function() { 
