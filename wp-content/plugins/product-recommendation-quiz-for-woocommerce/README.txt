...
Tags: product recommendation, quiz builder, woocommerce, conversion optimization, sales automation, sales funnel
...
A personal shopper for WooCommerce. Create quizzes that do the selling for you, recover abandoned carts, capture leads and grow your audience.
...
* You need to have the [WooCommerce](https://wordpress.org/plugins/woocommerce/ "WooCommerce open-source eCommerce") plugin installed and activated on your WordPress website.
...
* Grant permissions to connect our app to your WooCommerce
* Follow the **Success Checklist** to create and publish your quiz
* Drive traffic to your quiz and start getting sales and leads!

**MANUAL INSTALLATION**

First, download the latest version of our extension [here](https://woocommerce.com/products/product-recommendation-quiz-for-woocommerce/ "Product Recommendation Quiz for WooCommerce").
