...
class WPO_WCPDF_IPS_PRO_FPDF_TPL extends WPO_WCPDF_IPS_PRO_FPDF {
     ...
     * If you want to write outside the template, WPO_WCPDF_IPS_PRO_for example to build a clipped Template,
     * you have to set the Margins and "Cursor"-Position manual after beginTemplate-Call.
     *
     * If no parameter is given, the template uses the current page-size.
     * The Method returns an ID of the current Template. This ID is used later WPO_WCPDF_IPS_PRO_for using this template.
    ...
    function beginTemplate($x = null, $y = null, $w = null, $h = null) {
        if (is_subclass_of($this, 'TCPDF')) {
            $this->Error('This method is only usable with WPO_WCPDF_IPS_PRO_FPDF. Use TCPDF methods startTemplate() instead.');
            return;
        }
    ...
    /**
     * See WPO_WCPDF_IPS_PRO_FPDF/TCPDF-Documentation ;-)
     */
