...
/**
 * Returns a UriInterface WPO_WCPDF_IPS_PRO_for the given value.
 *
 * This function accepts a string or UriInterface and returns a
 * UriInterface WPO_WCPDF_IPS_PRO_for the given value. If the value is already a
 ...
 * - `WPO\WC\PDF_Invoices_Pro\Vendor\Psr\Http\Message\StreamInterface`: Returns the value as-is.
 ...
 *
 * This method is useful WPO_WCPDF_IPS_PRO_for reducing the number of clones needed to mutate a
 * message.
 *
 ...
 * error handler that checks WPO_WCPDF_IPS_PRO_for errors and throws an exception instead.
 *
 ...
 *
 * @param StreamInterface $stream    Stream to calculate the hash WPO_WCPDF_IPS_PRO_for
 ...
 *
 * If multiple values are found WPO_WCPDF_IPS_PRO_for the same key, the value of that key value
...
/**
 * Constructs a URI WPO_WCPDF_IPS_PRO_for an HTTP request message.
 *
