...
namespace WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox;

use WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Models\DeletedMetadata;
use WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Models\File;
use WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Models\Account;
use WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Models\Thumbnail;
use WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Models\AccountList;
use WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Models\ModelFactory;
use WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Models\FileMetadata;
use WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Models\CopyReference;
use WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Models\FolderMetadata;
use WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Models\ModelCollection;
use WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Authentication\OAuth2Client;
use WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Store\PersistentDataStoreFactory;
use WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Authentication\DropboxAuthHelper;
use WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Exceptions\DropboxClientException;
use WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Security\RandomStringGeneratorFactory;
use WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Http\Clients\DropboxHttpClientFactory;
...
class Dropbox
{
     ...
     * The Dropbox App
     *
     * @var \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\DropboxApp
     */
    protected $app;
     ...
     * Dropbox Client
     *
     * @var \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\DropboxClient
     */
    protected $client;
     ...
     * OAuth2 Client
     *
     * @var \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Authentication\OAuth2Client
     */
     ...
     *
     * @var \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Security\RandomStringGeneratorInterface
     */
     ...
     *
     * @var \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Store\PersistentDataStoreInterface
     */
     ...
     *
     * @param \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\DropboxApp
     ...
     *
     * @return \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Authentication\DropboxAuthHelper
     */
     ...
     * Get OAuth2Client
     *
     * @return \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Authentication\OAuth2Client
     */
     ...
     * Get the Dropbox App.
     *
     * @return \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\DropboxApp Dropbox App
     */
     ...
     * Get the Client
     *
     * @return \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\DropboxClient
     */
    ...
    /**
     * Get the Metadata WPO_WCPDF_IPS_PRO_for a file or folder
     *
    ...
    public function getMetadata($path, array $params = [])
    {
        ...
        if ($path === '/') {
            throw new DropboxClientException("Metadata WPO_WCPDF_IPS_PRO_for the root folder is unsupported.");
        }
     ...
     *
     * @return \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\DropboxResponse
     */
     ...
     *
     * @return \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Dropbox Dropbox Client
     */
     ...
     *
     * @return \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Models\ModelInterface
     *
     * @throws \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Exceptions\DropboxClientException
     */
     ...
     *
     * @return \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Models\MetadataCollection
     */
    ...
    /**
     * Get a cursor WPO_WCPDF_IPS_PRO_for the folder's state.
     *
     * @param  string $path   Path to the folder. Defaults to root.
     * @param  array  $params Additional Params
     *
     * @return string The Cursor WPO_WCPDF_IPS_PRO_for the folder's state
     *
     * @throws \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Exceptions\DropboxClientException
     *
     ...
     *
     * @return \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Models\ModelCollection
     */
    public function listRevisions($path, array $params = [])
    {
        ...
        //them as \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Models\FileMetadata manually.
        $body = $response->getDecodedBody();
    ...
    /**
     * Search a folder WPO_WCPDF_IPS_PRO_for files/folders
     *
     ...
     *
     * @return \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Models\SearchResults
     */
     ...
     *
     * @return \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Models\FolderMetadata
     *
     * @throws \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Exceptions\DropboxClientException
     *
     ...
     *
     * @return \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Models\DeletedMetadata
     *
     * @throws \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Exceptions\DropboxClientException
     *
     ...
     *
     * @return \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Models\DeletedMetadata|\WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Models\FileMetadata
     *
     * @throws \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Exceptions\DropboxClientException
     *
     ...
     * @param  string $rev  Revision to store WPO_WCPDF_IPS_PRO_for the file
     *
     * @return \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Models\DeletedMetadata|\WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Models\FileMetadata|\WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Models\FolderMetadata
     *
     * @throws \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Exceptions\DropboxClientException
     *
     ...
     *
     * @return \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Models\CopyReference
     *
     * @throws \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Exceptions\DropboxClientException
     *
     ...
     *
     * @return \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Models\TemporaryLink
     *
     * @throws \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Exceptions\DropboxClientException
     */
     ...
     * @param $asyncJobId
     *
     * @return \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Models\FileMetadata|string Status (failed|in_progress) or FileMetadata (if complete)
     *
     * @throws \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Exceptions\DropboxClientException
     *
     ...
     *
     * @return \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\DropboxFile
     */
     ...
     * @param  boolean            $close       Closes the session WPO_WCPDF_IPS_PRO_for "appendUploadSession"
     *
     * @return string Unique identifier WPO_WCPDF_IPS_PRO_for the upload session
     *
     * @throws \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Exceptions\DropboxClientException
     *
     * @link https://www.dropbox.com/developers/documentation/http/documentation#files-upload_session-start
     ...
     * @param  boolean            $close       Closes the session WPO_WCPDF_IPS_PRO_for futher "appendUploadSession" calls
     *
     * @return string Unique identifier WPO_WCPDF_IPS_PRO_for the upload session
     *
     * @throws \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Exceptions\DropboxClientException
    ...
    public function appendUploadSession($dropboxFile, $sessionId, $offset, $chunkSize, $close = false)
    {
        ...
        //response validation WPO_WCPDF_IPS_PRO_for this request.
    ...
    /**
     * Get a thumbnail WPO_WCPDF_IPS_PRO_for an image
     *
     * @param  string $path   Path to the file you want a thumbnail to
     * @param  string $size   Size WPO_WCPDF_IPS_PRO_for the thumbnail image ['thumb','small','medium','large','huge']
     * @param  string $format Format WPO_WCPDF_IPS_PRO_for the thumbnail image ['jpeg'|'png']
     *
     * @return \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Models\Thumbnail
     *
     * @throws \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Exceptions\DropboxClientException
     *
    ...
    protected function getMetadataFromResponseHeaders(DropboxResponse $response)
    {
        ...
        //Empty metadata WPO_WCPDF_IPS_PRO_for when
     ...
     *
     * @return \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Models\File
     *
     * @throws \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Exceptions\DropboxClientException
     *
     ...
     *
     * @return \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Models\Account
     */
     ...
     * Get Account
     *
     * @param string $account_id Account ID of the account to get details WPO_WCPDF_IPS_PRO_for
     *
     ...
     *
     * @param array $account_ids IDs of the accounts to get details WPO_WCPDF_IPS_PRO_for
     *
     * @link https://www.dropbox.com/developers/documentation/http/documentation#users-get_account_batch
     *
     * @return \WPO\WC\PDF_Invoices_Pro\Vendor\Kunnu\Dropbox\Models\AccountList
     */
    ...
    /**
     * Get Space Usage WPO_WCPDF_IPS_PRO_for the current user's account
     *
