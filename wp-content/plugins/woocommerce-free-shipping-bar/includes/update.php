	...
	class VillaTheme_Plugin_Updater extends Plugin_Upgrader {
		...
		public function plugin_update_row( $file, $plugin_data ) {
			...
			if ( is_network_admin() || ! is_multisite() ) {
				...
				printf( __( 'New version of %1$s available. You can download or <a href="%2$s" class="thickbox" title="%3$s">view version %4$s</a>. Please make sure that you fill your auto-update key in <a href="%5$s">Setting page</a>.' ),
