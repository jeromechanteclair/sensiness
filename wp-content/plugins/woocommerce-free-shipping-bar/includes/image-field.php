                ...
                <div class="option">
                    <div class="controls">
                        ...
                        <div class="upload_button_div">
                            <span class="vi-ui button green media_upload_button"><?php esc_html_e( 'Select Image', 'woocommerce-free-shipping-bar' ) ?></span>
                            <span title="<?php echo esc_attr( $field_name ) ?>"
                                  id="reset_<?php echo esc_attr( $field_name ) ?>"
                                  class="vi-ui button red remove-image "><?php esc_html_e( 'Remove', 'woocommerce-free-shipping-bar' ) ?></span>
                        </div>
